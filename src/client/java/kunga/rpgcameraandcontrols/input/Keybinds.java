...
public final class Keybinds {
    public static final KeyBinding.Category CATEGORY_RPG_CAMERA_AND_CONTROLS = KeyBinding.Category.create(Identifier.of("rpg", "rpg-camera-and-controls"));
